...
// 24. Official WhatsApp Brand Icon
export const WhatsAppBrandIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
...
// 25. Official Google Reviews Star Badge Icon
export const GoogleReviewBrandIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
