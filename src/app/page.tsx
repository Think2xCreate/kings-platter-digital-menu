...
import { HeroFoodBanner } from '../components/menu/HeroFoodBanner';
import { CategoryNavigation } from '../components/menu/CategoryNavigation';
import { SearchAndFilterBar } from '../components/menu/SearchAndFilterBar';
import { CategorySection } from '../components/menu/CategorySection';
import { CategoryDedicatedView } from '../components/menu/CategoryDedicatedView';
import { FoodDetailModal } from '../components/menu/FoodDetailModal';
import { ShowcaseMenuDrawer } from '../components/menu/ShowcaseMenuDrawer';
import { CartTrayDrawer } from '../components/menu/CartTrayDrawer';
import { MobileBottomNav } from '../components/layout/MobileBottomNav';
import { MobileSearchModal } from '../components/menu/MobileSearchModal';
...
import { EmptySearchState, ErrorState } from '../components/menu/MenuStates';
        ...
        <div className="min-h-screen bg-[#0D0D10] text-[#E8E8ED] flex flex-col selection:bg-[#E5A93C]/30 selection:text-[#FBBF24]">
          ...
          <main className="flex-1 w-full px-2 sm:px-4 lg:px-8 pt-3 sm:pt-6 pb-24 lg:pb-12">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-start">
              ...
              <div className="hidden lg:block lg:col-span-3 xl:col-span-3 sticky top-24 z-30">
                <div className="bg-[#131317] border border-[#24242C] rounded-2xl p-3 shadow-xl">
